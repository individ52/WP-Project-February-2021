...
<section class="section section-about">
  <picture>
    ...
    <img class="section-about__img lazy" src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII=" data-src="<?php echo carbon_get_post_meta($page_id, 'about_img') ?>" alt="">
  </picture>
  ...
  <div class="container section-contacts__container">
    ...
    <div class="contacts">
      <div class="contacts__start">
        <div class="contacts__map" id="ymap" data-coordinates="<?php echo $GLOBALS['pizza_time']['map_coordinates']; ?>"></div>
      </div>
